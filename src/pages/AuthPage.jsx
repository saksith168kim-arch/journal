      ...
      <div className="ath-body">
        ...
        >
          ...
          <div className="ath-glass ath-card">
            ...
            <button onClick={handleGoogle} className="ath-google" disabled={submitting }>
              ...
              {submitting  ? 'Please wait...' : t('google_btn')}
            </button>
            ...
            <form onSubmit={handleSubmit} className="ath-form">
              ...
              <button type="submit" disabled={submitting} className="ath-btn ath-btn--primary ath-submit">
                {submitting  ? t('btn_please_wait') : mode === 'login' ? t('btn_sign_in') : t('btn_create_account')}
              </button>
            </form>
