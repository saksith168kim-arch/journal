...
Respond ONLY with a JSON object, no markdown, no backticks, no explanation. Just the raw JSON:
{"grade":"B","headline":"...","strengths":["..."],"weaknesses":["..."],"topTip":"...","bestStrategy":"...","worstStrategy":"..."}`
          }]
        })
      })
      ...
      setError('Error: ' + (e.message || 'Could not generate review. Try again.'))
    } finally {
      setLoading(false)
    }
  }
